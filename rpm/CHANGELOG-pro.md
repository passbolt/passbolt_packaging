* [5.14.0-test.4-1] Thu, 16 Jul 2026 Passbolt SA package signing key <contact@passbolt.com>
...
* [5.14.0-test.3-1] Thu, 16 Jul 2026 Passbolt SA package signing key <contact@passbolt.com>
- PB-49943 Add a model cache health check service
- PB-50621 Add recover flow support for OAuth2 & ADFS SSO providers
- PB-52153 Add a command to insert dummy data into the email_queue table
- PB-52421 Add more verbose logs when an SSO provider response is in an incorrect format
...
* [5.14.0-test.2-1] Thu, 16 Jul 2026 Passbolt SA package signing key <contact@passbolt.com>
- PB-49943 Add a model cache health check service
- PB-50621 Add recover flow support for OAuth2 & ADFS SSO providers
- PB-52153 Add a command to insert dummy data into the email_queue table
- PB-52421 Add more verbose logs when an SSO provider response is in an incorrect format
...
* [5.14.0-test.1-1] Thu, 16 Jul 2026 Passbolt SA package signing key <contact@passbolt.com>
- PB-49943 Add a model cache health check service
- PB-50621 Add recover flow support for OAuth2 & ADFS SSO providers
- PB-52153 Add a command to insert dummy data into the email_queue table
- PB-52421 Add more verbose logs when an SSO provider response is in an incorrect format
...
* [5.13.0-1] Thu, 11 Jun 2026 Passbolt SA package signing key <contact@passbolt.com>
...
* [5.10.0-2] Mon, 23 Mar 2026 Daniel del Rio Figueira <daniel@passbolt.com>
...
* [5.9.0-1] Mon, 26 Jan 2026 Passbolt SA package signing key <contact@passbolt.com>
...
* [5.8.0-1] Mon, 22 Dec 2025 Passbolt SA package signing key <contact@passbolt.com>
...
* [5.7.0-1] Thu, 13 Nov 2025 Passbolt SA package signing key <contact@passbolt.com>
...
* [5.6.0-rc.1-1] Mon, 06 Oct 2025 Passbolt SA package signing key <contact@passbolt.com>
- PB-45058 Add datacheck to check for existing metadata key with no metadata private keys
- PB-44187 As an admin I cannot delete a metadata key associated with a deleted resource
- PB-44183 As a user that is sole owner of v4 resources when v4 resources types are disabled, v4 resources should be ignored on an ownership transfer request
- PB-44770 As a user I want to configure the trusted_proxies list as an environment variable
...
* [5.3.2-1] Thu, 17 Jul 2025 Passbolt SA package signing key <contact@passbolt.com>
